...
public class Database {
    ...
    public void initDB() throws SQLException {
        ...
        this.stm.executeUpdate("CREATE TABLE IF NOT EXISTS emprestimos (livro_idlivro VARCHAR(45) NOT NULL ,Alunos_CGM VARCHAR(40) NOT NULL ,dataSaida Date NULL ,dataDevolucao DATE NULL ,status VARCHAR(45) NULL ,PRIMARY KEY (livro_idlivro, Alunos_CGM) ,CONSTRAINT fk_livro_has_Alunos_livro1 FOREIGN KEY (livro_idlivro ) REFERENCES livros (idlivro ), CONSTRAINT fk_livro_has_Alunos_Alunos1 FOREIGN KEY (Alunos_CGM ) REFERENCES alunos (CGM ))");
    }
}
